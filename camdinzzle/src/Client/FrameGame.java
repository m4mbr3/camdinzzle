...
//				System.out.println("Creata la cella "+i+"X"+ j);
	...
	public void mouseClicked(MouseEvent arg0) 
	{
		 ...
		 * se il messaggio non ï¿½ null viene aggiornato la descrizione dello stato dino appena cresciuto
		 */
		 ...
		 *  se la risposta ï¿½ diversa da null controlla il messaggio
		 *  se non ï¿½ no ridisegna la mappa altrimenti crea un popup
		 */
		...
		/*CLASSIFICA
		 * tasto sempre attivo
		 * se la risposta non ï¿½ null e non no, crea un popup con la classifica
		 ...
		 * se la risposta ï¿½ null o no crea popup con errore
		 * altrimenti nulla
		 */
...
//TODO  mettere aggiorna lista giocatori in fondo
	 ...
	 * se il server risponde con errato messaggio mapList ï¿½ null e viene rifatta la richiesta per un numero massimo uguale a maxAttempt
	 * @param mapList
	 */
	 ...
	 * nel caso in cui il messaggio ï¿½ null viene rifatta la richiesta per maxAttempt volte
...
/*							if(col==maxCol)
	 ...
	 * se msgDinoList ï¿½ null fa la richiesta per un numero pari a maxAttempt dopo di che crea un popup di errore
	 * se il messaggio contiene no crea un popup di errore
	 * se il messaggio ï¿½ valido stampa la lista dei dinosauri
