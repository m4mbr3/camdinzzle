...
/**
 * Interfaccia utilizzata per definire un comportamento comune per ogni tipo di connessione scelta per connettersi al
 * server.
 */
public interface ConnectionManager {
	 ...
	 * @param name il nome della razza
	 * @param type il tipo della razza
	 * @return Risposta del Server, se va in errore ritorna null
	 */
